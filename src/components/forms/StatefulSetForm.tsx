...
import { StatefulSetResource, EnvVar, EnvFromSource, Volume, Container, Probe, VolumeMount, K8sResource, ConfigMapResource, SecretResource } from '../../types';
import { isConfigMap, isSecret } from '../../utils/typeGuards';
import { Input, Label, Select, CollapsibleSection } from '../FormComponents';
import { Box, Database, Plus, Trash2, HardDrive, Zap, Cpu } from 'lucide-react';
...
export const StatefulSetForm: React.FC<Props> = ({ data, onChange, savedResources = [] }) => {
    const { t } = useLanguage();
